                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="Gender">
                                    ...
                                    <option value="male" {{ 'male' == $Students->Gender ? 'selected' : '' }}>
                                        male</option>
                                    <option value="female" {{ 'female' == $Students->Gender ? 'selected' : '' }}>
                                        female</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="Blood_type_id">
                                    ...
                                    @foreach ($bloods as $bg)
                                        <option value="{{ $bg->id }}"
                                            {{ $bg->id == $Students->Blood_type_id ? 'selected' : '' }}>
                                            {{ $bg->Name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{ $Students->Birthday_Date }}"
                                    id="datepicker-action" name="Birthday_Date" data-date-format="yyyy-mm-dd">
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="academic_year">
                                    ...
                                    @for ($year = $current_year; $year <= $current_year + 1; $year++)
                                        <option value="{{ $year }}"
                                            {{ $year == $Students->Acadimic_year ? 'selected' : ' ' }}>
                                            {{ $year }}</option>
                                    @endfor
                                </select>
                            </div>
