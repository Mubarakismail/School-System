                                    ...
                                    <tbody>
                                        @foreach ($students as $student)
                                            <tr>
                                                ...
                                                <td>{{ $student->grade->getTranslation('Name', 'en') }}</td>
                                                <td>{{ $student->classroom->getTranslation('Name', 'en') }}</td>
                                                <td>{{ $student->section->getTranslation('Name_section', 'en') }}</td>
                                                <td>
