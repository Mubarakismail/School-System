                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('Sections.store') }}" method="POST">
                            ...
                            <div class="col">
                                <label for="inputName"
                                    class="control-label">{{ trans('Sections_trans.Teacher_Name') }}</label>
                                <select multiple name="Teacher_id[]" class="custom-select" onchange="console.log($(this).val())">
                                    <!--placeholder-->
                                    <option value="" selected disabled>
                                        {{ trans('Sections_trans.Select_Teacher') }}
                                    </option>
